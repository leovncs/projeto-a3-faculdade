...
public class MainViewController implements Initializable {
    ...
    public void onMenuItemEmployeeAction() {
        loadView("/project/workshop/gui/EmployeeList.fxml", (EmployeeListController controller) -> {
    ...
    public void onMenuItemDepartmentAction() {
        loadView("/project/workshop/gui/DepartmentList.fxml", (DepartmentListController controller) -> {
    ...
    public void onMenuItemAboutAction() {
        loadView("/project/workshop/gui/About.fxml", x -> {});
    }
